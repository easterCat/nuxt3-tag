...
import { _ as f } from './nuxt-img.9e48b4e4.mjs';
...
const S = defineComponent({ __name: "chitu", __ssrInlineRender: true, setup(r2) {
  s(), p();
  const { TemplateApi: x2 } = x(), $2 = async (e2) => {
  ...
  const S2 = ref([]), T2 = ref(0), H2 = ref(true), U = ref(""), X = ref({}), E = ref(false), R = ref(1), Y = ref(50), B = ref();
  let D = [], J = 0;
  const L = (e2) => {
    U.value = e2;
  }, O = () => {
    ...
    B.value.scrollHeight - (e2 + (document.documentElement.clientHeight || document.body.clientHeight)) <= 100 && (console.log("\u89E6\u5E95"), T2.value ? (J++, O()) : (R.value++, (async () => {
      const e3 = await x2.getTemplatesChitu({ pageIndex: R.value, pageSize: Y.value });
  ...
  return onUnmounted(() => {
    ...
    const r3 = n, m2 = g, p2 = d, d2 = ElSwitch, x3 = f, k2 = ElTooltip, $3 = t, U2 = a, R2 = w;
    i2(`<div${ssrRenderAttrs(mergeProps({ class: "chitu-tags-page page" }, u2))} data-v-1e2f68d8>`), i2(ssrRenderComponent(r3, null, null, s2)), i2('<div class="content" data-v-1e2f68d8>'), i2(ssrRenderComponent(m2, { placeholder: "\u641C\u7D22\u6807\u7B7E", onSearchChange: L }, null, s2)), i2(ssrRenderComponent(p2, { title: "\u6807\u7B7E\u7C7B\u522B" }, null, s2)), i2('<div class="type-list" data-v-1e2f68d8>'), i2(ssrRenderComponent(r3, null, null, s2)), i2("</div>"), i2(ssrRenderComponent(p2, { title: "\u6807\u7B7E\u5217\u8868" }, { titleSide: withCtx((e2, t2, l2, a2) => {
      if (!t2)
    ...
    }), _: 1 }, s2)), unref(J) ? (i2('<div class="tag-list" data-v-1e2f68d8>'), i2(ssrRenderComponent(r3, null, null, s2)), i2("</div>")) : i2("<!---->"), T2.value ? (i2('<div class="tag-list" data-v-1e2f68d8>'), i2(ssrRenderComponent(r3, null, null, s2)), i2("</div>")) : (i2('<div class="tag-list" data-v-1e2f68d8><!--[-->'), ssrRenderList(S2.value, (e2, t2) => {
      var l2;
      i2(`<div class="tag-item-img ll-media bg-base-100"${ssrRenderAttr("data-index", t2)} data-v-1e2f68d8>`), H2.value && 5 !== T2.value && 6 !== T2.value ? (i2('<div class="image-con" data-v-1e2f68d8>'), (null == e2 ? void 0 : e2.min_imgbb_url) ? i2(ssrRenderComponent(x3, { src: null != (l2 = null == e2 ? void 0 : e2.min_imgbb_url) ? l2 : "", placeholder: [100, 50, 10], loading: "lazy", onClick: (t3) => ((e3) => {
        T2.value ? (X.value = { author: e3.author, n_prompt: e3.n_prompt, preview: e3.preview, model: e3.model, prompt: e3.prompt, prompt_zh: e3.prompt_zh, name: e3.name, desc: e3.desc }, E.value = true) : (X.value = { name: e3.name, author: e3.author, preview: e3.imgbb_url ? e3.imgbb_url : e3.preview, prompt: e3.prompt, prompt_zh: e3.prompt_zh, n_prompt: e3.n_prompt, model: e3.model, desc: e3.desc, like: e3.like }, E.value = true);
      })(e2) }, null, s2)) : i2("<!---->"), i2("</div>")) : i2("<!---->"), i2('<div class="text-con" data-v-1e2f68d8>'), i2(ssrRenderComponent(k2, { class: "box-item", effect: "dark", content: null == e2 ? void 0 : e2.prompt, placement: "top" }, { default: withCtx((t3, l3, a2, o2) => {
        if (!l3)
        ...
        (null == e2 ? void 0 : e2.title) ? l3(`<p class="en" data-v-1e2f68d8${o2}>${ssrInterpolate((null == e2 ? void 0 : e2.title.length) > 24 ? (null == e2 ? void 0 : e2.title.slice(0, 24)) + "..." : null == e2 ? void 0 : e2.title)}</p>`) : l3(`<p class="en" data-v-1e2f68d8${o2}>${ssrInterpolate((null == e2 ? void 0 : e2.prompt.length) > 24 ? (null == e2 ? void 0 : e2.prompt.slice(0, 24)) + "..." : null == e2 ? void 0 : e2.prompt)}</p>`);
      }), _: 2 }, s2)), i2('</div><div class="button-con" data-v-1e2f68d8><button class="btn btn-sm btn-circle btn-accent m-r-10" data-v-1e2f68d8>'), i2(ssrRenderComponent($3, null, null, s2)), i2('</button><button class="btn btn-sm btn-circle btn-secondary" data-v-1e2f68d8>'), i2(ssrRenderComponent(U2, null, null, s2)), i2("</button></div></div>");
...
const H = tn(S, [["__scopeId", "data-v-1e2f68d8"]]);
