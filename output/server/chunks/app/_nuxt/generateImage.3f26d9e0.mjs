...
const A = defineComponent({ __name: "generateImage", __ssrInlineRender: true, setup(u2) {
  ...
  return (a2, t2, u3, n2) => {
    ...
    t2(`<div${ssrRenderAttrs(mergeProps({ class: "tranfer-con" }, n2))} data-v-ba805351><div class="button-con" data-v-ba805351><button class="btn btn-secondary btn-sm m-r-10" data-v-ba805351> \u6E05\u7A7A `), t2(ssrRenderComponent(g2, { class: "m-l-6", name: "ant-design:delete-filled" }, null, u3)), t2('</button><button class="btn btn-sm btn-accent m-r-10" data-v-ba805351> \u8D2D\u7269\u8F66\u5BFC\u5165 '), t2(ssrRenderComponent(g2, { class: "m-l-6", name: "clarity:shopping-cart-solid-badged" }, null, u3)), t2(`</button><button class="btn btn-primary btn-sm m-r-10" data-v-ba805351>${ssrInterpolate(unref(E) ? "\u56FE\u7247\u751F\u6210\u4E2D" : "\u751F\u6210")} `), unref(E) ? t2(ssrRenderComponent(g2, { class: "m-l-6", name: "line-md:loading-twotone-loop" }, null, u3)) : t2(ssrRenderComponent(g2, { class: "m-l-6", name: "entypo:brush" }, null, u3)), t2("</button></div>"), t2(ssrRenderComponent(M, { gutter: 20 }, { default: withCtx((l2, e2, a3, t3) => {
      if (!e2)
      ...
      e2(ssrRenderComponent(N, { xs: 24, sm: 24, md: 12, lg: 8, xl: 8 }, { default: withCtx((l3, e3, a4, t4) => {
        ...
        e3(`<input type="range" min="1" max="9"${ssrRenderAttr("value", unref(A2))} class="range range-xs" step="1" data-v-ba805351${t4}><div class="flex justify-between w-full text-xs" data-v-ba805351${t4}><span data-v-ba805351${t4}>1\u5F20</span><span data-v-ba805351${t4}>2\u5F20</span><span data-v-ba805351${t4}>3\u5F20</span><span data-v-ba805351${t4}>4\u5F20</span><span data-v-ba805351${t4}>5\u5F20</span><span data-v-ba805351${t4}>6\u5F20</span><span data-v-ba805351${t4}>7\u5F20</span><span data-v-ba805351${t4}>8\u5F20</span><span data-v-ba805351${t4}>9\u5F20</span></div>`);
      }), _: 1 }, a3, t3));
    }), _: 1 }, u3)), unref(D) ? (t2('<div class="g-image m-t-20" data-v-ba805351><ul data-v-ba805351><!--[-->'), ssrRenderList(unref(D), (l2, e2) => {
      t2(`<li data-v-ba805351><img${ssrRenderAttr("src", l2)} alt="" data-v-ba805351></li>`);
      ...
      e2(`<span class="title-side" data-v-ba805351${t3}>\u603B\u6570:${ssrInterpolate(unref(B2))}\u6761</span>`);
    }), _: 1 }, u3)), unref(T2) && (null == (f2 = unref(T2)) ? void 0 : f2.length) ? (t2('<div class="history-con" data-v-ba805351><div class="button-con" data-v-ba805351><button class="btn btn-accent btn-sm" data-v-ba805351>\u6E05\u7A7A\u5386\u53F2</button></div><!--[-->'), ssrRenderList(unref(T2), (l2, e2) => {
      t2(`<div class="history-item" data-v-ba805351><p style="${ssrRenderStyle({ "font-weight": "bold", "margin-bottom": "4px" })}" data-v-ba805351>`), t2(0 === e2 ? ssrRenderComponent(Y, { style: { color: "#67c23a", "font-size": "12px" } }, null, u3) : "<!---->"), t2(`<span data-v-ba805351>${ssrInterpolate(null == l2 ? void 0 : l2.time)}</span></p><p data-v-ba805351>${ssrInterpolate(null == l2 ? void 0 : l2.prompt)}</p><div class="history-button" data-v-ba805351><button class="btn btn-sm btn-secondary m-r-10" data-v-ba805351> \u5220\u9664 `), ssrRenderSlot(a2.$slots, "icon", {}, () => {
        t2(ssrRenderComponent(Z, { class: "m-l-6" }, null, u3));
      }, t2, u3), t2('</button><button class="btn btn-sm btn-accent m-r-10" data-v-ba805351> \u590D\u5236 '), ssrRenderSlot(a2.$slots, "icon", {}, () => {
        t2(ssrRenderComponent(ll, { class: "m-l-6" }, null, u3));
      }, t2, u3), t2('</button><button class="btn btn-sm btn-primary" data-v-ba805351> \u9009\u62E9 '), t2(ssrRenderComponent(g2, { class: "m-l-6", name: "icon-park-solid:full-selection" }, null, u3)), t2("</button></div></div>");
    }), t2("<!--]--></div>")) : t2('<div class="tags-con" data-v-ba805351><p class="no-data" data-v-ba805351>\u6682\u65E0\u8BB0\u5F55</p></div>'), t2("</div>");
  };
} }), T = A.setup;
A.setup = (l2, e2) => {
...
const B = tn(A, [["__scopeId", "data-v-ba805351"]]);
